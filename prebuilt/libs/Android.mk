...
LOCAL_MODULE_CLASS = SHARED_LIBRARIES
LOCAL_MODULE_SUFFIX = .so
LOCAL_EXPORT_C_INCLUDE_DIRS = libdpframework/include
LOCAL_SRC_FILES_64 = $(PROPRIETARY_PATH)/lib64/libdpframework.so
LOCAL_SRC_FILES_32 = $(PROPRIETARY_PATH)/lib/libdpframework.so
LOCAL_MULTILIB := both
include $(BUILD_PREBUILT)
